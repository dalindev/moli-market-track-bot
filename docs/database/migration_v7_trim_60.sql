...
-- Run this AFTER migration_v5_item_level.sql
...
-- Summary:
-- ============================================
-- Changed outlier trimming from 10%/10% to 20%/20%
-- Before: PERCENT_RANK >= 0.10 AND <= 0.90 (middle 80%)
-- After:  PERCENT_RANK >= 0.20 AND <= 0.80 (middle 60%)
-- This removes more extreme prices for a better "normal market value"
-- Falls back to untrimmed median if not enough data after trimming
